...
class AppMain:
    ...
    def _config_container_l(self):
        ...
        self.__opt_menu_books.grid(row=0, column=1)
        ...
        self.__list_summary.grid(row=1, column=1)
    ...
    def _config_container_r(self):
        ...
        self.__text_screen.grid(row=1, column=2)
    ...
    def _config_container_d(self):
        for i in self.__buts_others[0]:
            i.pack()
        self.__buts_others[1].grid(row=0, rowspan=1, column=1)
        ...
        scr_note_y.grid(row=0, column=3, sticky=N + S)
